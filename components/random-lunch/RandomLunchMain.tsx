                    ...
                    <div
                        ...
                        <div className={'relative'}>
                            ...
                            <div className="absolute z-1 bottom-[330px] flex items-center flex-col left-[210px]">
                                <Image src={num1} alt="num1" onClick={handleCurrenStep} className={'cursor-pointer'}/>
                                <p className="text-32 text-black cursor-pointer" onClick={handleCurrenStep}>제품팀 랜식(화)</p>
                            </div>

                            <div className="absolute z-1 bottom-[280px] flex items-start flex-col left-[560px]">
                                <Image src={num2} alt="num1" onClick={handleCurrenStep} className={'cursor-pointer'}/>
                                <p className="text-32 text-black cursor-pointer" onClick={handleCurrenStep}>서본 랜식 (화)</p>
                            </div>

                            <div className="absolute z-1 top-[350px] left-[550px] flex items-center flex-col">
                                <Image src={num3} alt="num1" onClick={handleCurrenStep} className={'cursor-pointer'}/>
                                <p className="text-32 text-black cursor-pointer" onClick={handleCurrenStep}>전체 랜식 (금)</p>
                            </div>
                        </div>
                    </div>
                )
